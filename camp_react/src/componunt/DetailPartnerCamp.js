                ...
                <div className={'row my-3'}>
                    <div className={'col-sm-3'}>
                        <div className={'input-group'}>
                            ...
                            <input className={'form-control'} value={dtTruncateText(campDetails.campDt, 10)} readonly={true}/>
                        </div>
                    </div>
                </div>
                    ...
                    <div className={'col-sm-3'}>
                        <div className={'input-group'}>
                            <div className={'input-group-text'}>
                                <input className={'form-check-input'} type={'checkbox'} value={campDetails.kidszoneYn}  checked={updatedCampInfo.kidszoneYn === "Y"}
                                       name="kidszoneYn"
