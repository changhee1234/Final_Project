  ...
  return (
      <div className={'col-sm-8 mx-auto'}>
        <ul className={'col-sm text-center my-4'}>
          <li className={'me-2'}><i className="bi bi-pencil"></i><span className={'text3 me-5'}> 캠핑장 정보 수정</span></li>
        </ul>
        {campDetails ? (
            <form onSubmit={handleSubmit}>
                ...
                <div className={'col-6'}>
                  <div className={'input-group'}>
                    ...
                    <input className={'form-control'} value={updatedCampInfo.campName || ''}
                           name="campName" onChange={handleInputChange}/>
                  </div>
                </div>
              ...
              <div className={'row'}>
                ...
                <div className={'col-3'}>
                      <div className={'input-group'}>
                        <input className={'form-control text-secondary'} value={'*키즈존 여부'}
                               readOnly={true}/>
                  ...
                  <div className={'input-group'}>
                    <span className={'input-group-text'}>홈페이지 URL</span>
              ...
              <div className={'row my-5'}>
                <div className={'d-flex justify-content-end'}>
                  <button type={'submit'} className={'w-btn w-btn-indigo me-2'}>수정</button>
                  <button type={'reset'} className={'w-btn-outline w-btn-red-outline'}
                          onClick={handleMainInfoDeleteButton}>삭제
                  </button>
                </div>
              </div>
            </form>
        ...
        <div className={'row my-2'}>
          <ul className={'col-sm text-center'}>
            <li className={'me-2'}><i className="bi bi-pencil"></i><span className={'text3 me-5'}> 구역 수정</span></li>
          </ul>          <div className={'d-flex justify-content-between'}>
            ...
            {editingArea ? (
                ...
                <div className={'mx-2 col-sm-3'}>
                  <div className={'d-grid mx-2'}>
                    <button
                        type={'button'}
                        className={'w-btn w-btn-indigo p-1'}
        ...
        <div className={'d-grid'}>
          <button type={'reset'} className={'w-btn w-btn-gray my-5'} onClick={handleCancel}>취소</button>
        </div>
      </div>
  );
}
