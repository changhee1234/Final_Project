        ...
        {step === 1 && (
            <form onSubmit={handleCampRegisterNext}>
              <ul className={'col-sm text-center my-4'}>
                <li className={'me-2'}><i className="bi bi-pencil"></i><span className={'text3 me-5'}> 캠핑장 정보 입력</span>
                </li>
              </ul>
              ...
              <div className={'row'}>
                <div className="col-3 input-group">
                  <label htmlFor="customFileInput" className="input-group-text">*썸네일 이미지</label>
                  <input
                      type="file"
                      className="form-control"
                      name="file"
              ...
              {/*홈페이지*/}
              <div className={'input-group'}>
                <label className={'input-group-text'}>홈페이지 URL</label>
              ...
              <div className={'d-flex justify-content-end my-5'}>
                <div className={'col-sm-3'}>
                  <div className={'d-grid'}>
                    ...
                    <button className={'w-btn w-btn-indigo p-2'} type="submit">다음</button>
                  </div>
                </div>
              </div>
            </form>
            ...
            <form onSubmit={handleCampRegister2Submit}>
              {campSiteInfos.map((campSiteInfo, index) => (
                  <div key={index} className={'border-bottom'}>
                    <ul className={'col-sm text-center mt-5 mb-3'}>
                      <li className={'me-2'}><i className="bi bi-pencil">
                      </i><span className={'text3 me-5'}> 캠핑장 구역 정보 입력</span>
                      </li>
                    </ul>
              ...
              <div className={'row mt-5 mb-3'}>
                <div className={'col-sm-12'}>
                  <div className={'d-grid'}>
                    <button className={'w-btn w-btn-gray p-2'} onClick={handleAddCampSiteInfo}
                            type={'button'}>+
                    </button>
                  </div>
                </div>
              ...
              <div className={'row'}>
                <div className={'d-flex justify-content-end'}>
                  <div className={'col-sm-3'}>
                    <div className={'d-grid'}>
                      <button className="w-btn w-btn-indigo" type="submit">등록하기</button>
                    </div>
                  </div>
                </div>
              </div>
